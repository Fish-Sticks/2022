...
console_t::console_t(const std::string& title)
{
	DWORD old;
...
const console_t& console_t::operator<<(const std::string& str) const
{
	std::cout << str;
	return *this;
}

const console_t& console_t::operator<<(uintptr_t num) const
{
	std::cout << std::hex << num;
	return *this;
}

const console_t& console_t::operator<<(console_t::color col) const
{
